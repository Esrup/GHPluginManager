namespace GHPluginManager.ViewModels
{
  internal class GHPluginManagerHostPaneViewModel : Rhino.UI.ViewModel
  {
    public GHPluginManagerHostPaneViewModel(uint documentSerialNumber)
    {
      DocumentRuntimeSerialNumber = documentSerialNumber;
      GHPluginManagerPlugin.Instance.SettingsSaved +=
    ...
    public Rhino.PersistentSettings Settings => GHPluginManagerPlugin.Instance.Settings;
